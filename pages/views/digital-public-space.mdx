...
export const meta = {
  ...
  label: [
    {
      name: "ORBIT",
      value: "The irregular borderlands between the digital and the physical"
    },
    {
      name: "TECHNIQUES",
      value: "Pre-digital prompts, field reports, digital gardens, soft adaptive reuses, gameshow-style public consultations"
    },
    {
      name: "LAUNCH SITE",
