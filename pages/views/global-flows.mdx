...
export const meta = {
  ...
  description: `A set of scenarios on the future of global flows: people, data, commodities, capital.`,
  image: `/images/global-flows.jpg`,
  red: false,
  intro: `A set of scenarios on the future of global flows: people, data, commodities, capital.`,
  date: `Dec 2020`,
  sidebar: false,
  tags: [
    "Scenarios",
