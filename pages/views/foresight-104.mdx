...
export const meta = {
  title: `Scanning for weak signals`,
  description: `How to organize the search for ambiguous indicators of change`,
  image: `/images/foresight104.jpg`,
  red: false,
  intro: `How to organize the search for ambiguous indicators of change`,
  date: `2019`,
  sidebar: false,
  tags: [
    "Services",
