...
export const meta = {
  ...
  image: `/images/compersia_personacards-4.jpeg`,
  intro: `A mass-polyamory scenario documented with research and artifacts including a song and a paper-based card game`,
  date: `Sep 2018`,
  tags: ['Scenarios'],
  sidebar: false,
  label: [
...
[“All of You” is a love song from Compersia.](https://fromlater.com/views/all-of-you) Listen there or on Spotify, Soundcloud, Apple Music, Amazon, Google Play and other streaming services.
